                ...
                for (String key : chatsMap.keySet()) {
                    ...
                    volunteerAccDbr.get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            ...
                            if (!(Boolean) volChat.get("organization_read")) {
                                arrayAdapter.insert(volFirstName + " " + volLastName + ": " + volEmail, 0);
                            }
                            else {
                                arrayAdapter.add(volFirstName + " " + volLastName + ": " + volEmail);
